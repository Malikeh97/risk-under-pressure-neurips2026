...
| Model | C@0.5 GCG | C@0.5 PAIR | C@0.5 JB | AE GCG | AE PAIR | AE JB |
|---|---|---|---|---|---|---|
| Tulu3 Base | 59.3 → 55.7 | 11.2 → 6.4 | 9.2 → 3.8 | 8.4 → 8.6 | 39.0 → 68.4 | 53.3 → 129.2 |
| Tulu3 SFT | ∞ → ∞ | ∞ → ∞ | 52.4 → 13.3 | 0.5 → 0.6 | 3.5 → 6.4 | 8.9 → 37.7 |
| Tulu3 DPO | 521.2 → 462.7 | 79.9 → 39.3 | 40.9 → 14.5 | 1.0 → 1.1| 6.0 → 11.5 | 10.4 → 31.4 |
| Tulu3 RLVR | 503.6 → 447.2 | 72.4 → 42.7 | 25.7 → 10.0 | 1.0 → 1.2 | 6.7 → 12.1 | 18.9 → 48.1 |
| Qwen2.5 0.5B | 20.0 → 8.5 | 15.5 → 6.1 | 8.2 → 0.3 | 25.6 → 58.7 | 30.6 → 74.3 | 59.6 → 1677.8 |
| Qwen2.5 3B | 173.7 → 146.5 | 33.9 → 16.5 | 13.4 → 2.5 | 3.3 → 3.9 | 15.9 → 33.6 | 36.8 → 217.8 |
| Qwen2.5 7B | 399.7 → 337.5 | 38.9 → 22.5 | 22.8 → 6.7 | 1.3 → 1.5 | 13.6 → 21.8 | 23.0 → 76.8 |
| Qwen3 4B | ∞ → ∞ | 31.3 → 15.5 | 21.2 → 4.6 | 0.9 → 1.0 | 16.6 → 33.4 | 22.1 → 105.7 |
| Qwen3 4B-SafeRL | 189.0 → 156.8† | 44.8 → 21.5 | 24.5 → 6.4 | 2.1 → 2.5† | 7.6 → 16.0 | 16.0 → 67.4 |
